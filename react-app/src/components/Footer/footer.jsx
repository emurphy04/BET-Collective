      ...
      <div className="footer-container">
        <footer className="footer">
          ...
          <div className="footer-section customer-support">
            ...
            <ul>
              <li><Link to="/shipping" className="navText">About BET</Link></li>
              <li><Link to="/faq" className="navText">FAQs</Link></li>
              <li><Link to="/support" className="navText">Support Policies</Link></li>
            </ul>
          </div>
          {/* Shopping Links */}
